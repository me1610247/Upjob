...
<head>
	...
	<title>UPjob | Find Best Jobs</title>
...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="navbar-brand" href="{{route('home')}}">UPjob</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-0 ms-sm-0 me-auto mb-2 mb-lg-0 ms-lg-4">
					...
					<li class="nav-item">
						<a class="nav-link text-danger" aria-current="page" href="{{route('account.logout')}}">Logout</a>
					</li>	
                    @endif								
				</ul>		
				@if(!Auth::check())		
